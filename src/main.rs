...
fn start_sim() {
    ...
    let appliances = vec![
        appliance::Appliance::new("dishwasher".to_string(), Energy::new(10), vec![10, 11]),
    ...
    let solar_panels = Option::Some(vec![solar_panel::SolarPanel::new(Energy::new(10), 10)]);
    let house1 = house::House::new(appliances, solar_panels);

    let appliances = vec![
        appliance::Appliance::new("oven".to_string(), Energy::new(5), vec![11]),
        appliance::Appliance::new(
            "heater".to_string(),
            Energy::new(15),
            vec![19, 20, 21, 22],
    ...
    let world = world::World::new(
        grid::Grid::new(Price::new(6), Price::new(3)),
