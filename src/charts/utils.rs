...
pub fn total_period_price_market_grid_only(trades: &mut Vec<Order>, order_side: OrderSide, grid: &Grid) -> f32 {
...
pub fn average_day_prices(total_period_prices: &Vec<f32>) -> Vec<f32> {
    const DAY: usize = 48;
    total_period_prices
        .chunks(DAY)
